...
#define HEATING_TEMP_READ_INTERVAL 1000   // 1 second - measurement interval
#define HEATING_TEMP_AVERAGE_INTERVAL 5000 // 5 seconds - average calculation interval
#define HEATING_TEMP_THRESHOLD 0.1        // 0.1°C change threshold for publishing
#define HEATING_TEMP_AVERAGE_COUNT 5      // Number of measurements to average
