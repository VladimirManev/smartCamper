...
- Температурата се измерва непрекъснато с async неблокиращ метод (на всеки 1 секунда, усреднена за 5 секунди)
...
- Релето се включва веднага след първото четене на температурата (~1 секунда след включване на кръга)
- Хистерезис предотвратява бързо превключване (разлика 2°C)
- Работи напълно офлайн (не се изисква мрежа)
- Проверка на контрол на всеки 30 секунди (или веднага когато има нова температура)
...
- **Веднагашен контрол на релето**: Релето се включва веднага след първото четене на температурата (~1 секунда след включване на кръга)
