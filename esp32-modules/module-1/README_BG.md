...
Модул 1 е ESP32-базиран сензорен модул, проектиран за системата SmartCamper. Предоставя мониторинг на температура и влажност чрез DHT22/AM2301 сензор, и мониторинг на нивото на сивата вода чрез електроди базирани на проводимост, с разширяема архитектура, която позволява добавяне на допълнителни сензори.
...
- **Обработка на Данни**: Mode (най-често срещаната стойност) от последните 5 измерения
