...
|------------------|----------|
| 1 кратко + hold ≥3 s | Toggle зона 1 нормално |
| 2 кратки + hold ≥3 s | Toggle зона 2 |
| 3 кратки + hold ≥3 s | Toggle зона 1 cat mode |
| Друго | Дълъг error beep |

Конфликт между normal/cat докато е armed → error; първо disarm със същата последователност.
