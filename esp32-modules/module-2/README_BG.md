...
Модулът включва power relay (GPIO 14), който физически прекъсва захранването на всички LED ленти, когато всички са изключени. Това предотвратява консумацията на ток в standby режим (над 0.5A) от WS2812 контролерите.
