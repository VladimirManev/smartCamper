 ...
 * Driver door known: E 06214000 byte1 bit 0x04 (set=open).
 *
 * Wiring:
 ...
 * Wait for "Ready", then open/close one door at a time.
 */
...
void setup() {
  ...
  Serial.println("Known: driver door E 06214000 byte1 bit0x04");
